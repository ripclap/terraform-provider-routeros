...
`,
		...
		ResourcesMap: map[string]*schema.Resource{
			...
			"routeros_ipv6_firewall_raw":               ResourceIPv6FirewallRaw(),
			...
			"routeros_app":                                                 ResourceApp(),
			"routeros_app_settings":                                        ResourceAppSettings(),
			"routeros_certificate_crl":                                     ResourceCertificateCrl(),
			"routeros_certificate_scep_server_ra":                          ResourceCertificateScepServerRa(),
			"routeros_certificate_settings":                                ResourceCertificateSettings(),
			"routeros_console_settings":                                    ResourceConsoleSettings(),
			"routeros_disk":                                                ResourceDisk(),
			"routeros_disk_btrfs_filesystem":                               ResourceDiskBtrfsFilesystem(),
			"routeros_disk_btrfs_subvolume":                                ResourceDiskBtrfsSubvolume(),
			"routeros_disk_btrfs_transfer":                                 ResourceDiskBtrfsTransfer(),
			"routeros_file_rsync_daemon":                                   ResourceFileRsyncDaemon(),
			"routeros_file_sync":                                           ResourceFileSync(),
			"routeros_interface_bridge_calea":                              ResourceInterfaceBridgeCalea(),
			"routeros_interface_bridge_host":                               ResourceInterfaceBridgeHost(),
			"routeros_interface_bridge_mdb":                                ResourceInterfaceBridgeMdb(),
			"routeros_interface_bridge_msti":                               ResourceInterfaceBridgeMsti(),
			"routeros_interface_bridge_nat":                                ResourceInterfaceBridgeNat(),
			"routeros_interface_bridge_port_mst_override":                  ResourceInterfaceBridgePortMstOverride(),
			"routeros_interface_eoipv6":                                    ResourceInterfaceEoipv6(),
			...
			"routeros_interface_ethernet_switch_qos_settings":              ResourceInterfaceEthernetSwitchQosSettings(),
			"routeros_interface_ethernet_switch_qos_tx_manager":            ResourceInterfaceEthernetSwitchQosTxManager(),
			"routeros_interface_ipipv6":                                    ResourceInterfaceIPIPv6(),
			"routeros_interface_l2tp_ether":                                ResourceInterfaceL2tpEther(),
			"routeros_interface_l2tp_server_binding":                       ResourceInterfaceL2tpServerBinding(),
			"routeros_interface_lte_settings":                              ResourceInterfaceLteSettings(),
			"routeros_interface_macsec":                                    ResourceInterfaceMacsec(),
			"routeros_interface_macsec_profile":                            ResourceInterfaceMacsecProfile(),
			"routeros_interface_mesh":                                      ResourceInterfaceMesh(),
			"routeros_interface_mesh_port":                                 ResourceInterfaceMeshPort(),
			"routeros_interface_ppp_client":                                ResourceInterfacePppClient(),
			"routeros_interface_ppp_server":                                ResourceInterfacePppServer(),
			"routeros_interface_pppoe_server_server":                       ResourceInterfacePppoeServerService(),
			"routeros_interface_pptp_client":                               ResourceInterfacePptpClient(),
			"routeros_interface_pptp_server":                               ResourceInterfacePptpServerBinding(),
			"routeros_interface_pptp_server_server":                        ResourceInterfacePptpServer(),
			"routeros_interface_vpls":                                      ResourceInterfaceVpls(),
			"routeros_interface_wifi_network":                              ResourceWifiNetwork(),
			"routeros_interface_wifi_network_radio":                        ResourceWifiNetworkRadio(),
			"routeros_iot_modbus":                                          ResourceIotModbus(),
			"routeros_iot_modbus_security_rules":                           ResourceIotModbusSecurityRules(),
			"routeros_iot_mqtt_brokers":                                    ResourceIotMqttBrokers(),
			"routeros_iot_mqtt_subscriptions":                              ResourceIotMqttSubscriptions(),
			"routeros_ip_cloud_back_to_home_file":                          ResourceIpCloudBackToHomeFile(),
			"routeros_ip_cloud_back_to_home_file_settings":                 ResourceIpCloudBackToHomeFileSettings(),
			"routeros_ip_cloud_back_to_home_user":                          ResourceIpCloudBackToHomeUser(),
			"routeros_ip_dhcp_server_alert":                                ResourceIpDhcpServerAlert(),
			"routeros_ip_firewall_calea":                                   ResourceIPFirewallCalea(),
			"routeros_ip_firewall_service_port":                            ResourceIPFirewallServicePort(),
			"routeros_ip_ipsec_key_psk":                                    ResourceIpIpsecKeyPsk(),
			"routeros_ip_ipsec_key_qkd":                                    ResourceIpIpsecKeyQkd(),
			"routeros_ip_kid_control":                                      ResourceIpKidControl(),
			"routeros_ip_kid_control_device":                               ResourceIpKidControlDevice(),
			"routeros_ip_media":                                            ResourceIpMedia(),
			"routeros_ip_media_settings":                                   ResourceIpMediaSettings(),
			"routeros_ip_packing":                                          ResourceIpPacking(),
			"routeros_ip_proxy":                                            ResourceIpProxy(),
			"routeros_ip_proxy_access":                                     ResourceIpProxyAccess(),
			"routeros_ip_proxy_cache":                                      ResourceIpProxyCache(),
			"routeros_ip_proxy_direct":                                     ResourceIpProxyDirect(),
			"routeros_ip_reverse_proxy":                                    ResourceIpReverseProxy(),
			"routeros_ip_service_webserver":                                ResourceIpServiceWebserver(),
			"routeros_ip_smb_shares":                                       ResourceIpSMBShares(),
			"routeros_ip_smb_users":                                        ResourceIpSMBUsers(),
			"routeros_ip_socks":                                            ResourceIpSocks(),
			"routeros_ip_socks_access":                                     ResourceIpSocksAccess(),
			"routeros_ip_socks_users":                                      ResourceIpSocksUsers(),
			"routeros_ip_socksify":                                         ResourceIpSocksify(),
			"routeros_ipv6_dhcp_relay":                                     ResourceIPv6DhcpRelay(),
			"routeros_ipv6_dhcp_relay_option":                              ResourceIPv6DhcpRelayOption(),
			"routeros_ipv6_dhcp_server_binding":                            ResourceIPv6DhcpServerBinding(),
			"routeros_ipv6_nd_prefix_default":                              ResourceIPv6NdPrefixDefault(),
			"routeros_ipv6_nd_proxy":                                       ResourceIPv6NdProxy(),
			"routeros_ipv6_nd_settings":                                    ResourceIPv6NdSettings(),
			"routeros_ipv6_neighbor":                                       ResourceIPv6Neighbor(),
			"routeros_mpls_interface":                                      ResourceMplsInterface(),
			"routeros_mpls_ldp":                                            ResourceMplsLdp(),
			"routeros_mpls_ldp_accept_filter":                              ResourceMplsLdpAcceptFilter(),
			"routeros_mpls_ldp_advertise_filter":                           ResourceMplsLdpAdvertiseFilter(),
			"routeros_mpls_ldp_interface":                                  ResourceMplsLdpInterface(),
			"routeros_mpls_ldp_local_mapping":                              ResourceMplsLdpLocalMapping(),
			"routeros_mpls_ldp_neighbor":                                   ResourceMplsLdpNeighbor(),
			"routeros_mpls_ldp_remote_mapping":                             ResourceMplsLdpRemoteMapping(),
			"routeros_mpls_mangle":                                         ResourceMplsMangle(),
			"routeros_mpls_settings":                                       ResourceMplsSettings(),
			"routeros_mpls_traffic_eng_interface":                          ResourceMplsTrafficEngInterface(),
			"routeros_mpls_traffic_eng_path":                               ResourceMplsTrafficEngPath(),
			"routeros_mpls_traffic_eng_tunnel":                             ResourceMplsTrafficEngTunnel(),
			"routeros_openflow":                                            ResourceOpenflow(),
			"routeros_openflow_port":                                       ResourceOpenflowPort(),
			"routeros_partitions":                                          ResourcePartitions(),
			"routeros_port":                                                ResourcePort(),
			"routeros_port_remote_access":                                  ResourcePortRemoteAccess(),
			"routeros_ppp_l2tp_secret":                                     ResourcePPPL2tpSecret(),
			"routeros_queue_interface":                                     ResourceQueueInterface(),
			"routeros_routing_bgp_vpls":                                    ResourceRoutingBgpVpls(),
			"routeros_routing_fantasy":                                     ResourceRoutingFantasy(),
			"routeros_routing_filter_community_ext_list":                   ResourceRoutingFilterCommunityExtList(),
			"routeros_routing_filter_community_large_list":                 ResourceRoutingFilterCommunityLargeList(),
			"routeros_routing_filter_community_list":                       ResourceRoutingFilterCommunityList(),
			"routeros_routing_filter_num_list":                             ResourceRoutingFilterNumList(),
			"routeros_routing_filter_select_rule":                          ResourceRoutingFilterSelectRule(),
			"routeros_routing_gmp":                                         ResourceRoutingGmp(),
			"routeros_routing_igmp_proxy":                                  ResourceRoutingIgmpProxy(),
			"routeros_routing_igmp_proxy_mfc":                              ResourceRoutingIgmpProxyMfc(),
			"routeros_routing_isis_instance":                               ResourceRoutingIsisInstance(),
			"routeros_routing_isis_interface_template":                     ResourceRoutingIsisInterfaceTemplate(),
			"routeros_routing_ospf_interface":                              ResourceRoutingOspfInterface(),
			"routeros_routing_ospf_static_neighbor":                        ResourceRoutingOspfStaticNeighbor(),
			"routeros_routing_pimsm_bsr_candidate":                         ResourceRoutingPimsmBsrCandidate(),
			"routeros_routing_pimsm_bsr_rp_candidate":                      ResourceRoutingPimsmBsrRpCandidate(),
			"routeros_routing_pimsm_instance":                              ResourceRoutingPimsmInstance(),
			"routeros_routing_pimsm_interface_template":                    ResourceRoutingPimsmInterfaceTemplate(),
			"routeros_routing_pimsm_static_rp":                             ResourceRoutingPimsmStaticRp(),
			"routeros_routing_rip_instance":                                ResourceRoutingRipInstance(),
			"routeros_routing_rip_interface_template":                      ResourceRoutingRipInterfaceTemplate(),
			"routeros_routing_rip_keys":                                    ResourceRoutingRipKeys(),
			"routeros_routing_rip_static_neighbor":                         ResourceRoutingRipStaticNeighbor(),
			"routeros_routing_rpki":                                        ResourceRoutingRpki(),
			"routeros_routing_settings":                                    ResourceRoutingSettings(),
			"routeros_special_login":                                       ResourceSpecialLogin(),
			"routeros_system_clock_manual":                                 ResourceSystemClockManual(),
			"routeros_system_console":                                      ResourceSystemConsole(),
			"routeros_system_health_settings":                              ResourceSystemHealthSettings(),
			"routeros_system_ntp_client_servers":                           ResourceSystemNtpClientServer(),
			"routeros_system_ntp_key":                                      ResourceSystemNtpKey(),
			"routeros_system_package_local_update_mirror":                  ResourceSystemPackageLocalUpdateMirror(),
			"routeros_system_package_local_update_update_package_source":   ResourceSystemPackageLocalUpdatePackageSource(),
			"routeros_system_package_update":                               ResourceSystemPackageUpdate(),
			"routeros_system_ptp":                                          ResourceSystemPtp(),
			"routeros_system_ptp_port":                                     ResourceSystemPtpPort(),
			"routeros_system_resource_hardware_usb_settings":               ResourceSystemResourceHardwareUsbSettings(),
			"routeros_system_resource_irq":                                 ResourceSystemResourceIrq(),
			"routeros_system_resource_irq_rps":                             ResourceSystemResourceIrqRps(),
			"routeros_system_ups":                                          ResourceSystemUps(),
			"routeros_system_watchdog":                                     ResourceSystemWatchdog(),
			"routeros_tool_graphing":                                       ResourceToolGraphingSettings(),
			"routeros_tool_romon":                                          ResourceToolRomon(),
			"routeros_tool_romon_port":                                     ResourceToolRomonPort(),
			"routeros_tool_sms":                                            ResourceToolSms(),
			"routeros_tool_traffic_generator":                              ResourceToolTrafficGenerator(),
			"routeros_tool_traffic_generator_packet_template":              ResourceToolTrafficGeneratorPacketTemplate(),
			"routeros_tool_traffic_generator_port":                         ResourceToolTrafficGeneratorPort(),
			"routeros_tool_traffic_generator_raw_packet_template":          ResourceToolTrafficGeneratorRawPacketTemplate(),
			"routeros_tool_traffic_generator_stream":                       ResourceToolTrafficGeneratorStream(),
			"routeros_tool_traffic_monitor":                                ResourceToolTrafficMonitor(),
			"routeros_user_manager_payment":                                ResourceUserManagerPayment(),
			"routeros_zerotier_controller_member":                          ResourceZerotierControllerMember(),
			"routeros_zerotier_peer_hint":                                  ResourceZerotierPeerHint(),
		},
