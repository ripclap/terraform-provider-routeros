# routeros_routing_pimsm_static_rp (Data Source)
...
- `entries` (List of Object) Entries read from `/routing/pimsm/static-rp`, narrowed by `filter`. (see [below for nested schema](#nestedatt--entries))
