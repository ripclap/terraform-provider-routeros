# routeros_interface_list_member (Data Source)
...
- `entries` (List of Object) Entries read from `/interface/list/member`, narrowed by `filter`. (see [below for nested schema](#nestedatt--entries))
