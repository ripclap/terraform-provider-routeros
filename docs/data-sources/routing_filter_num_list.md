# routeros_routing_filter_num_list (Data Source)
...
- `entries` (List of Object) Entries read from `/routing/filter/num-list`, narrowed by `filter`. (see [below for nested schema](#nestedatt--entries))
