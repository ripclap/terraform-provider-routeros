# routeros_interface_ethernet_switch_qos_map (Data Source)
...
- `entries` (List of Object) Entries read from `/interface/ethernet/switch/qos/map`, narrowed by `filter`. (see [below for nested schema](#nestedatt--entries))
