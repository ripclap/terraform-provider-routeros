# routeros_ipv6_nd_proxy (Data Source)
...
- `entries` (List of Object) Entries read from `/ipv6/nd/proxy`, narrowed by `filter`. (see [below for nested schema](#nestedatt--entries))
