# routeros_interface_ethernet_switch_port_isolation (Data Source)
...
- `entries` (List of Object) Entries read from `/interface/ethernet/switch/port-isolation`, narrowed by `filter`. (see [below for nested schema](#nestedatt--entries))
