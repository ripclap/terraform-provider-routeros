# routeros_tool_graphing_interface (Data Source)
...
- `entries` (List of Object) Entries read from `/tool/graphing/interface`, narrowed by `filter`. (see [below for nested schema](#nestedatt--entries))
