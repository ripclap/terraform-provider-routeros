# routeros_container_envs (Data Source)
...
- `entries` (List of Object) Entries read from `/container/envs`, narrowed by `filter`. (see [below for nested schema](#nestedatt--entries))
