# routeros_user_manager_router (Data Source)
...
- `entries` (List of Object) Entries read from `/user-manager/router`, narrowed by `filter`. (see [below for nested schema](#nestedatt--entries))
