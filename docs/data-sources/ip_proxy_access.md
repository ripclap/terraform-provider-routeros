# routeros_ip_proxy_access (Data Source)
...
- `entries` (List of Object) Entries read from `/ip/proxy/access`, narrowed by `filter`. (see [below for nested schema](#nestedatt--entries))
