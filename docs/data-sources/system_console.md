# routeros_system_console (Data Source)
...
- `entries` (List of Object) Entries read from `/system/console`, narrowed by `filter`. (see [below for nested schema](#nestedatt--entries))
