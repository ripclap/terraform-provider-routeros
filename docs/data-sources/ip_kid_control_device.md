# routeros_ip_kid_control_device (Data Source)
...
- `entries` (List of Object) Entries read from `/ip/kid-control/device`, narrowed by `filter`. (see [below for nested schema](#nestedatt--entries))
