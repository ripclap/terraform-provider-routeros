# routeros_ip_cloud_back_to_home_file (Data Source)
...
- `entries` (List of Object) Entries read from `/ip/cloud/back-to-home-file`, narrowed by `filter`. (see [below for nested schema](#nestedatt--entries))
