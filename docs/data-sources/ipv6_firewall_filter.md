# routeros_ipv6_firewall_filter (Data Source)
...
- `entries` (List of Object) Entries read from `/ipv6/firewall/filter`, narrowed by `filter`. (see [below for nested schema](#nestedatt--entries))
