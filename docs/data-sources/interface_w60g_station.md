# routeros_interface_w60g_station (Data Source)
...
- `entries` (List of Object) Entries read from `/interface/w60g/station`, narrowed by `filter`. (see [below for nested schema](#nestedatt--entries))
