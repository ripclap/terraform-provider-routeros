# routeros_ip_socks_access (Data Source)
...
- `entries` (List of Object) Entries read from `/ip/socks/access`, narrowed by `filter`. (see [below for nested schema](#nestedatt--entries))
