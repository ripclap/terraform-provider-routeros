# routeros_interface_wireguard (Data Source)
...
- `entries` (List of Object) Entries read from `/interface/wireguard`, narrowed by `filter`. (see [below for nested schema](#nestedatt--entries))
