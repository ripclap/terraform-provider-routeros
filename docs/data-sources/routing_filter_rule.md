# routeros_routing_filter_rule (Data Source)
...
- `entries` (List of Object) Entries read from `/routing/filter/rule`, narrowed by `filter`. (see [below for nested schema](#nestedatt--entries))
