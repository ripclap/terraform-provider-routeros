# routeros_ipv6_firewall_nat (Data Source)
...
- `entries` (List of Object) Entries read from `/ipv6/firewall/nat`, narrowed by `filter`. (see [below for nested schema](#nestedatt--entries))
