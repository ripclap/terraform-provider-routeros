# routeros_port_remote_access (Data Source)
...
- `entries` (List of Object) Entries read from `/port/remote-access`, narrowed by `filter`. (see [below for nested schema](#nestedatt--entries))
