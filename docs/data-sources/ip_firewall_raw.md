# routeros_ip_firewall_raw (Data Source)
...
- `entries` (List of Object) Entries read from `/ip/firewall/raw`, narrowed by `filter`. (see [below for nested schema](#nestedatt--entries))
