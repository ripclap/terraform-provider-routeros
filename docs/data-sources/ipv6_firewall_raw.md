# routeros_ipv6_firewall_raw (Data Source)
...
- `entries` (List of Object) Entries read from `/ipv6/firewall/raw`, narrowed by `filter`. (see [below for nested schema](#nestedatt--entries))
