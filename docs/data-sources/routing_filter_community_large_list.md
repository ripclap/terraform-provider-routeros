# routeros_routing_filter_community_large_list (Data Source)
...
- `entries` (List of Object) Entries read from `/routing/filter/community-large-list`, narrowed by `filter`. (see [below for nested schema](#nestedatt--entries))
