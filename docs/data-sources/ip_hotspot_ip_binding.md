# routeros_ip_hotspot_ip_binding (Data Source)
...
- `entries` (List of Object) Entries read from `/ip/hotspot/ip-binding`, narrowed by `filter`. (see [below for nested schema](#nestedatt--entries))
