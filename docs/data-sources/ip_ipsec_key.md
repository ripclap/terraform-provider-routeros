# routeros_ip_ipsec_key (Data Source)
...
- `entries` (List of Object) Entries read from `/ip/ipsec/key`, narrowed by `filter`. (see [below for nested schema](#nestedatt--entries))
