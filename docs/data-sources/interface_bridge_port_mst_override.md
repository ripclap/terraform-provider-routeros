# routeros_interface_bridge_port_mst_override (Data Source)
...
- `entries` (List of Object) Entries read from `/interface/bridge/port/mst-override`, narrowed by `filter`. (see [below for nested schema](#nestedatt--entries))
