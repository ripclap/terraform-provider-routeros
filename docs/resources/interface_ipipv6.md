# routeros_interface_ipipv6 (Resource)
...
- `name` (String) Name of the IPIPv6 interface.
...
#The command for the terminal is -> :put [/interface/ipipv6 get [print show-ids]]
terraform import routeros_interface_ipipv6.ipipv6 "*1"
```
