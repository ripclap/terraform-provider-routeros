...
- `paypal_password` (String, Sensitive) The password of the PayPal API account.
...
- `web_private_password` (String, Sensitive) The password for accessing `/um/PRIVATE/` section over HTTP.
