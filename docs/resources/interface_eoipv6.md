# routeros_interface_eoipv6 (Resource)
...
- `name` (String) Name of the EoIPv6 interface.
...
- `dscp` (String) Set dscp value in GRE header to a fixed value '0..63' or 'inherit' from dscp value taken from tunneled traffic.
...
- `actual_mtu` (Number)
- `current_remote_address` (String) The IPv6 address of the remote end of the tunnel the interface is currently bound to.
...
#The command for the terminal is -> :put [/interface/eoipv6 get [print show-ids]]
terraform import routeros_interface_eoipv6.eoipv6 "*1"
```
