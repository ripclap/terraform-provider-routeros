# routeros_ipv6_firewall_raw (Resource)
...
#The command for the terminal is -> :put [/ipv6/firewall/raw get [print show-ids]]
terraform import routeros_ipv6_firewall_raw.raw "*1"
```
